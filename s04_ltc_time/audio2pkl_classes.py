...
def main():
    ...
    for index_numba in range(len(class_names)):
        ...
        sr = int(16e3)
        # crop_s_00 = sr
        # crop_e_00 = sr * (crop_sec + 1)
        # print(crop_s_00, "To", crop_e_00)
        # print((crop_e_00) - (crop_s_00))

        # crop_s_01 = int(sr * (crop_sec + 1) / sr - 2)
        # crop_e_01 = int(sr * (crop_sec * 2 + 1) / sr - 2)
        # print(sr * (crop_sec + 1) / sr - 2, "To", sr * (crop_sec * 2 + 1) / sr - 2)
        # print((sr * (crop_sec * 2 + 1) / sr - 2) - (sr * (crop_sec + 1) / sr - 2))

        # crop_s_02 = sr * (crop_sec + 1) / sr
        # crop_e_02 = sr * (crop_sec + 1)
        # print(sr * (crop_sec + 1) / sr, "to", sr * (crop_sec * 2 + 1) / sr)
        # print((sr * (crop_sec * 2 + 1) / sr) - (sr * (crop_sec + 1) / sr))
        # return 0 
        audio_data = [[
